...
mov esi, 0 ; Используем `esi` для хранения промежуточных сумм функций от различ. х
next:
...
mul ebx ; eax=ebx*eax
sub eax, 3 ; eax=eax-3
add esi,eax ; добавляем к промежуточной сумме функций от различ. х значение esi=esi+eax
